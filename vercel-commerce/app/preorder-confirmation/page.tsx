...
export default function PreorderConfirmationPage() {
  ...
  // Helper to format preorder available date
  const formatPreorderDate = (dateString: string | null | undefined) => {
  ...
  if (!order) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <span className="text-lg text-red-500">Could not load preorder details.</span>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-neutral-900">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8 animate-in fade-in-0 duration-700">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-purple-900/30 rounded-full mb-4 animate-in zoom-in-0 duration-500 delay-200">
        ...
        <div className="grid gap-6 md:gap-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 animate-in slide-in-from-bottom-4 duration-700 delay-300">
            ...
            <Card className="bg-neutral-800 text-white hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  <p className="text-sm text-neutral-400">Expected Availability</p>
                  <p className="font-medium text-purple-400 flex items-center gap-2">
                    <Calendar className="w-4 h-4" />
                    {formatPreorderDate(earliestPreorderDate)}
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-neutral-700">
                      ...
                      <TableHead className="text-neutral-200">Availability</TableHead>
                        ...
                        >
                          <TableCell>
                            <div className="relative">
                              ...
                              />
                              <Badge className="absolute -top-2 -right-2 bg-purple-600 text-white text-xs px-2 py-0.5">
                                Pre-Order
                              </Badge>
                            </div>
                          </TableCell>
                          ...
                          <TableCell>
                            <p className="text-sm text-purple-400">
                              {formatPreorderDate(availableDate)}
                            </p>
                          </TableCell>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in slide-in-from-bottom-4 duration-700 delay-700">
            <Button
              className="bg-purple-600 hover:bg-purple-700 transition-all duration-300 hover:scale-105 px-6 py-3 text-base font-medium rounded"
              asChild
            >
              <a href="/">
          ...
          <Card className="bg-purple-900/20 border-purple-800 animate-in slide-in-from-bottom-4 duration-700 delay-900">
            <CardContent className="pt-6">
              <div className="space-y-4">
                <div className="text-center space-y-2">
                  <h3 className="font-semibold text-purple-100 flex items-center justify-center gap-2">
                    <Clock className="w-5 h-5" />
                    What happens next?
                  </h3>
                ...
                <div className="text-center">
                  <p className="text-xs text-purple-300">
                    💳 Your payment has been processed. The item(s) will ship once they become available.
                  </p>
                </div>
              </div>
            </CardContent>
